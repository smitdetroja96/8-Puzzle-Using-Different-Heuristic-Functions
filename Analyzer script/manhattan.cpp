...
//----------------- To find manhattan distance of board ----------------//

ll manhattan(board curr_board, ll moves)
{
    ll mapping[n*n][2];
    ll val = 0;   
    FOR(i,0,n)
    ...
    ll totalManhattanDistance = moves;
    ...
    FOR(j,0,n)
    {
        ...
        totalManhattanDistance += abs(mapping[val][0] - i)+abs(mapping[val][1] - j);
    }
...
struct cmp
{
    ...
    {
        ld x = manhattan(a.first,a.second);
        ld y = manhattan(b.first,b.second);
        return x > y;
    }
};
